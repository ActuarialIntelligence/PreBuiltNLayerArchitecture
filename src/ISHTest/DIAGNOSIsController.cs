...
namespace ISHTest
{
    ...
    {
        private readonly ISHTestContext _context;

        public DIAGNOSIsController(ISHTestContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.DIAGNOSI != null ? 
                          ...
                          Problem("Entity set 'ISHTestContext.DIAGNOSI'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ISHTestContext.DIAGNOSI'  is null.");
            }
            var dIAGNOSI = await _context.DIAGNOSI.FindAsync(id);
            if (dIAGNOSI != null)
            {
